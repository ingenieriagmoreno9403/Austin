      ...
      @csrf
        <div class="row">
            <div class="col-lg-6 col-12 start-center">
                <h2 class="mt-1 animate_animated animate_backInLeft"> 
                    Creación de Proyecto - Materiales
                </h2>
        ...
        <div class="row">
            ...
            <div class="col-md-3 p-3 start-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-12 p-3 pt-1 pb-0">
                        <h6 class="m-0 p-0">Materiales del Proyecto</h6>
                        <span class="fs-8 text-secondary m-0 p-0">Gestión de Materiales</span>
                    </div>
                </div>
            ...
            <div class="col-md-9">
                    ...
                    <table class="table table-stripped table-hover display" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-success text-truncate fw-bold text-success">
                                    {{$item->cantidad_disponible}}
                                </td>

                                <td class="table-danger text-truncate fw-bold text-danger">
                ...
                <form action="/Servicios/Captura/InsertarMaterialesProyecto/{{$tipo}}/{{$id}}"  enctype="multipart/form-data" class="g-3 form needs-validation" novalidate>
                    @csrf
