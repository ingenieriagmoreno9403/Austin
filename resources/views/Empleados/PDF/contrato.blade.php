...
{{-- Página 1 --}}
<div>
    <div class="titulo">CONTRATO INDIVIDUAL DE TRABAJO POR TIEMPO INDETERMINADO</div>

    <p>
        CONTRATO INDIVIDUAL DE TRABAJO POR TIEMPO INDETERMINADO QUE CELEBRAN POR UNA PARTE
        LA FUENTE DE TRABAJO DENOMINADA {{$empresa}}, Y QUE EN
        ESTE ACTO ES REPRESENTADA POR EL ING. FERNANDO GUIJARRO HERRERA, EL CUAL ACREDITARÁ
        SU PERSONALIDAD EN EL APARTADO CORRESPONDIENTE; Y POR LA OTRA, LA
        C. <span class="campo">{{ $empleado }}</span>; DE CONFORMIDAD CON LAS SIGUIENTES DECLARACIONES Y
        CLÁUSULAS:
    </p>
    ...
    <p>
        ...
        denomine a la parte patronal {{$empresa}} como LA EMPRESA, a la
        parte trabajadora <span class="campo">{{ $empleado }}</span> como EL TRABAJADOR, a ambos como LAS PARTES y al
        presente instrumento como EL CONTRATO. Así mismo coinciden en que al Gerente General, Supervisor y/o Jefe
        de Departamento y ya sea que actúen conjunta o separadamente, se les denomine PERSONAL DIRECTIVO.
    </p>

    <p>
        03.- EL TRABAJADOR, bajo protesta de decir verdad, declara lo siguiente: ser de nacionalidad mexicana, con
        fecha de nacimiento del <span class="campo">{{ $fechaNacimientoFmt }}</span>, sexo <span class="campo">{{ $sexo }}</span> estado civil <span class="campo">{{ strtoupper($estado_civil) }}</span>, con domicilio
        particular en <span class="campo">{{ $direccion }}</span>., con número telefónico <span class="campo">{{ $telefono }}</span>, CURP
        <span class="campo">{{ $curp }}</span>, RFC <span class="campo">{{ $rfc }}</span>y Número de Seguridad Social
    ...
    <p>
        ...
        ANÓNIMA DE CAPITAL VARIABLE, cuyo único Domicilio Social es el ubicado en bulevar El Roble número 2137
        Col. Brittingham en Gómez Palacio, Durango; tener la Denominación y Razón Social ya citada; y en este acto
        pone a la vista de los que intervienen en la presente, los documentos que acreditan su legal existencia y cuyos
        datos de identificación se transcriben a continuación: A) Escritura Pública de fecha 16 de Marzo del 2000 pasada
        ante la Fe del Notario Público No 05 en ejercicio en esta ciudad, C. Lic. Sergio Estrella Ochoa, bajo el número
    </p>
</div>
...
<div>
    <p>
        3813 del libro 94 de escrituras públicas; Así mismo, el C. FERNANDO GUIJARRO HERRERA, cuya legal
        representación se desprende de la lectura del Documento Público citado, se identifica en este acto ante EL
        TRABAJADOR y los que intervienen en la presente, mediante Credencial para Votar expedida por el Instituto
        Federal Electoral con número de registro 0536061111540, y la cual le es devuelta una vez confirmados los
        rasgos físicos de la foto que aparece en el documento, con los del Representante Legal de LA EMPRESA.
    </p>
    ...
    <p>
        06.- LA EMPRESA declara que requiere los servicios de personal apto para el desarrollo de su control y
        administración.
    </p>
    ...
    <p>
        PRIMERA.- EL CONTRATO, en concordancia con lo establecido en los artículos 35 y 39 de LA LEY, se celebra
        por TIEMPO INDETERMINADO; y sólo podrá modificarse, rescindirse y terminarse en los casos y condiciones
        especificados en EL CONTRATO o en LA LEY.
    </p>
    ...
    <p>
        ...
        designe con los cargos de Gerente General, Jefe y/o Supervisor. Dichos servicios los desempeñará en el puesto
        de AUXILIAR DE PROYECTOS E INSTALACIONES y consistirán entre otras en:
    </p>

    <p>A.- Elaboración de cotizaciones y trato con clientes.</p>
    <p>B.- Control de Inventario para el departamento asignado.</p>
    <p>C.- Facturación.</p>
    <p>D.- Control de gastos de cuadrillas foráneas.</p>
    <p>E.- Manejo y control de equipo y medidas de seguridad.</p>
</div>
...
<div>
    <p>
        F.- Sujetarse a los horarios que le sean asignados, mismos que podrán ser modificados, de acuerdo a las
        necesidades de LA EMPRESA.
    </p>

    <p>
        G.- Cumplir y velar por el cumplimiento del Reglamento Interno de Trabajo, mismo que se adjunta al CONTRATO
        como Anexo I.
    </p>

    <p>H.- Tomar las capacitaciones que LA EMPRESA le indique.</p>
    ...
    <p>
        ...
        dentro de las instalaciones de la empresa será de 48 (cuarenta y ocho) horas a la semana, distribuidas de la
        siguiente manera: de lunes a viernes EL TRABAJADOR prestará los servicios de las 08:00 a las 13:30 horas,
        contando con 90 minutos para ir a tomar sus alimentos y/o descansar, con regreso a sus labores de las 15:00 a
        las 18:00 horas; y los sábados de las 08:00 a las 13:00 horas.
    </p>
...
<div>
    ...
    <p>
        ...
        <span class="campo">${{ number_format($salario_semanal, 2) }}</span> pagaderos en una sola emisión los días sábado. El citado pago incluye
        séptimo día y días festivos, por lo que se deduce que el salario del trabajador para todos los efectos legales es
        de: <span class="campo">${{ number_format($salario_diario, 2) }}</span> pesos diarios y de <span class="campo">${{ number_format($salario_hora, 2) }}</span> pesos por hora laborada, menos las deducciones a que se
        refiere el artículo 110 de LA LEY. EL TRABAJADOR solicita y LA EMPRESA acepta, que el salario y demás
        prestaciones sean pagados por conducto de una EMPRESA bancaria, a efecto de proteger sus remuneraciones
        contra robo e igualmente solicita EL TRABAJADOR que dicha EMPRESA bancaria lo sea la denominada Banco
        Mercantil del Norte para que le sean depositados los pagos semanales en su propia cuenta de nómina.
    </p>
    ...
    <p>
        DÉCIMA CUARTA.- En apego a los artículos 69 y 71 de LA LEY, EL TRABAJADOR gozará de un día de
    ...
    <p>
        DÉCIMA QUINTA.- LAS PARTES acuerdan y EL TRABAJADOR otorga su consentimiento expreso para que la
    ...
    <p>
        DÉCIMA SEXTA. En apego a lo dispuesto por el artículo 74 de LA LEY, serán días de descanso obligatorio los
        siguientes: 1º de enero, 5 de febrero, 21 de marzo, 1º de mayo, 16 de septiembre, 20 de noviembre y 25 de
        diciembre, así como el 1º de diciembre de cada seis años, cuando corresponda a la transmisión del Poder
        Ejecutivo Federal.
    </p>
</div>
...
<div>
    <p>
        DÉCIMA SÉPTIMA.- En lo relativo a Vacaciones y Prima Vacacional, LAS PARTES se sujetan a lo estipulado por
        ...
        podrá ser inferior a seis días laborables, y que aumentará en dos días laborables, hasta llegar a doce, por cada
        año subsecuente de servicios. Después del cuarto año, el período de vacaciones aumentará en dos días por
        cada cinco de servicios. ARTÍCULO 77.- Los trabajadores que presten servicios discontinuos y los de temporada
        tendrán derecho a un período anual de vacaciones, en proporción al número de días de trabajos en el año.
    </p>

    <p>
        DÉCIMA OCTAVA.- LA EMPRESA ofrece pagar AL TRABAJADOR el monto que por aguinaldo establece el
    ...
    <p>
        DÉCIMA NOVENA. LA EMPRESA proporcionará AL TRABAJADOR las herramientas de trabajo necesarias para
    ...
    <p>
        VIGÉSIMA.- LA EMPRESA se obliga a reintegrar AL TRABAJADOR los gastos que el mismo erogue al laborar
        en localidades y regiones que se encuentren a 100 o más kilómetros del domicilio de LA EMPRESA por los
        siguientes conceptos: 1) hospedaje, 2) comidas, 3) lavandería y 4) pasajes foráneos. EL TRABAJADOR se obliga
        a realizar las comprobaciones de gastos a más tardar a los 7 días naturales posteriores a haber retornado de la
        zona o zonas foráneas, exhibiendo los comprobantes fiscales o documentos que respalden las erogaciones por
        los conceptos numerados. Cuando los gastos sean depositados de manera anticipada por LA EMPRESA, deberá
        EL TRABAJADOR reintegrar las cantidades que excedan a las erogaciones realizadas en el mismo plazo de 7
        días señalados para la comprobación de gastos.
    </p>

    <p>
        VIGÉSIMA PRIMERA.- EL TRABAJADOR reconoce a LA EMPRESA como su único patrón y como la única
        responsable de las obligaciones materia del CONTRATO, por lo que se compromete a abstenerse de realizar
        reclamaciones a título personal relacionadas con EL CONTRATO a PERSONAL DIRECTIVO como a clientes y
        contratantes del servicio que brinda LA EMPRESA.
    </p>

    <p>
        VIGÉSIMA SEGUNDA. El CONTRATO podrá prorrogarse cuando la subsistencia de la materia de trabajo así lo
        exija y EL TRABAJADOR sea conforme en continuar la prestación del servicio.
    </p>

    <p>
        VIGÉSIMA TERCERA. Serán consideradas faltas de probidad y darán lugar a la rescisión del CONTRATO, sin
...
<div>
    ...
    <p>
        VIGÉSIMA CUARTA.- Las situaciones que no se prevean de manera expresa en EL CONTRATO quedarán
    ...
    <p>
        ...
        ÚLTIMA FOJA AL CALCE; EN GÓMEZ PALACIO, DURANGO; A LOS <span class="campo">{{ $diaFirma }}</span> DÍAS DEL MES DE <span class="campo">{{ $mesFirma }}</span> DEL
        AÑO <span class="campo">{{ $anioFirma }}</span>
    </p>
    ...
    <table class="firmas">
        ...
        <tr>
            <td>ING. FERNANDO GUIJARRO HERRERA</td>
            <td>C. {{ $empleado }}</td>
        </tr>
        <tr>
            <td>Rep. Legal.</td>
        ...
        <tr>
            <td colspan="2">Myrna M. Arreola Valdez</td>
        </tr>
    </table>
</div>
