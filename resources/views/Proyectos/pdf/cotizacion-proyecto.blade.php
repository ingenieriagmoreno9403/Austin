...
<head>
    ...
    <title>COTIZACIÓN PROYECTO {{ $servicio->folio }}</title>
...
<body>
    ...
    <div class="header">
        ...
        <div class="quotation-title"><b>COTIZACIÓN {{ $servicio->folio }}</b></div>
        @php
            $isHeaderDate = is_string($servicio->fecha_inicio ?? null) && preg_match('/^\d{4}-\d{2}-\d{2}/', $servicio->fecha_inicio);
            $headerDate = $isHeaderDate ? \Carbon\Carbon::parse($servicio->fecha_inicio)->format('d/m/Y') : date('d/m/Y');
        @endphp
        <div class="quotation-date"><b>{{ $headerDate }}</b></div>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="service-section">
            <div class="service-header">PROYECTO</div>
            <table class="table">
                    <thead>
                        <tr>
                            <th>PARTIDA</th>
                    ...
                    <tbody>
                        ...
                        @php($suma_total = $suma_total + $d->monto)
                        @endforeach
                    </tbody>
                ...
                <tfoot>
                    ...
                    @if(!is_null($revisor_condiciones))
                    <tr style="text-align: left!important">
                        <td  colspan="4"  
                        style="text-align: justify!important;
                        white-space: normal!important;
                        font-size:10px!important;">
                         {{ $revisor_condiciones->condiciones ?? 'N/A'}}
                        </td>
                    </tr>
                    @endif
                </tfoot>
