    ...
    <div class="container-fluid format_page">
        <div class="row">
            <div class="col-lg-3 col-6 start-center">
                <h3 class="mt-1 animate__animated animate__backInLeft">Proveedores</h3>
                ...
                <table class="table table-stripped table-hover display" id="table">
                    <thead>
                        <tr class="table-light text-secondary">
                            ...
                            <th class="text-center text-truncate fw-bold">Eliminar</th>
                            <th class="text-center text-truncate fw-bold">Productos</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($proveedores as $ltsproveedores)
                            <tr>
                                ...
                                <td>
                                    <a href="/EliminarProveedor/{{$ltsproveedores->id}}"
                                        class="btn btn-warning"><i class="fa-solid fa-trash"></i>
                                    </a>
                                </td>
                                <td>
                                    <a href="/ProductosProveedor/{{$ltsproveedores->id}}"
                                        class="btn btn-primary"><i class="fa-solid fa-rectangles-mixed">Productos</i>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
