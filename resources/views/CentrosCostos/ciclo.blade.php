...
<div class="cc-page" id="cc-app">
    <div class="cc-header">
        <div>
            ...
            <p class="cc-sub">Revisa las asignaciones del ciclo o crea una nueva: empresa SAP, usuario, centro, cuentas y permisos.</p>
        </div>
    ...
    <div class="cc-panel">
        <div class="cc-panel-head">
            ...
            <a class="cc-btn cc-btn-ink" href="{{ route('centros.asignar', $bootstrap['cicloCodigo'] ?? '') }}">
                <i class="fa-solid fa-user-plus"></i> Asignación
            </a>
        </div>
        ...
        <div class="cc-table-wrap">
            <table class="cc-table">
                ...
                <tbody id="asig-tbody">
                    <tr><td colspan="6"><div class="cc-empty">Aún no hay asignaciones. Usa el botón Asignación para crear la primera.</div></td></tr>
                </tbody>
            </table>
        </div>
    </div>
