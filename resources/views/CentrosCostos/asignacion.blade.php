        ...
        <div class="cc-asig-pair">
            <div class="cc-panel cc-asig-col">
                ...
                <div id="asig-cc-list" class="cc-pick-list" role="listbox" aria-label="Centros de costo">
                    <div class="cc-empty">Elige una empresa para ver centros</div>
                </div>
        ...
        <div class="cc-panel cc-perm-panel">
            ...
            <div class="cc-perm-grid is-wide" id="asig-permisos">
                ...
                @if(empty($bootstrap['permisosCatalogo']))
                    <label class="cc-perm-card"><input type="checkbox" name="permiso" value="capturar" checked><strong>Capturar</strong><span>Puede capturar presupuesto mensual</span></label>
                    <label class="cc-perm-card"><input type="checkbox" name="permiso" value="editar"><strong>Editar</strong><span>Puede modificar montos ya capturados</span></label>
    ...
    <div class="cc-footer-actions">
        ...
        <div class="cc-footer-actions-end">
            ...
            <button type="button" class="cc-btn" id="asig-fin-seguir">
                <i class="fa-solid fa-rotate"></i> Guardar y seguir asignando
            </button>
        </div>
    </div>
</div>
...
<script src="{{ asset('js/centros-asignaciones.js') }}"></script>
<script>
