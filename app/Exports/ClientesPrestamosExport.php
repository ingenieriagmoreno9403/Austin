...
class ClientesPrestamosExport implements   FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    ...
    {
        $obtenerCliPres=  $this->exportarclientesprestamos();
        return $obtenerCliPres;
    }

    public function headings(): array
    {
        return [
            ['CATALOGO GENERAL DE PRESTAMOS A CLIENTES'],
            [
                'ID CLI',
                'ESTADO CLI',
                'NOMBRE COMPLETO',
