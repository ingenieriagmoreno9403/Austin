...
return new class extends Migration
{
    ...
    {
        Schema::create('tblnotas_debito', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('id_factura_original');
            $table->string('factura_uuid', 100);
            $table->string('folio_factura', 25)->nullable();
            $table->enum('tipo_documento', ['comercial', 'fiscal'])->default('fiscal');
            ...
            $table->enum('estado', ['Registrada', 'Timbrada', 'Error', 'Pendiente'])->default('Pendiente');
    ...
    {
        Schema::dropIfExists('tblnotas_debito');
    }
};
